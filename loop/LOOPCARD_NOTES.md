...
- Shows the current iterations, red-rim caught failures, lessons, cloud tests, and failed-runs-logged (all read live from data/), the checker proof line, PR #207, PR #213, issue #208, and `yazan-o.github.io/ouroboros`.
