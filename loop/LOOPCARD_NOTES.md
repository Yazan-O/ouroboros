...
- Shows the current iterations, red-rim caught failures, lessons, and cloud tests (all read live from data/), 0 escaped to prod, the checker proof line, PR #207, PR #213, issue #208, and `ouroboros-phi.vercel.app`.
